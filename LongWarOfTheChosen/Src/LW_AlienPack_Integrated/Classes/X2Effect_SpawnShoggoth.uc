class X2Effect_SpawnShoggoth extends X2Effect_SpawnUnit;
...
function OnSpawnComplete(const out EffectAppliedData ApplyEffectParameters, StateObjectReference NewUnitRef, XComGameState NewGameState, XComGameState_Effect NewEffectState)
{
	...
	CivLifeLost = 0 ; //CivUnitGameState.GetCurrentStat(eStat_HP) - CivUnitGameState.GetMaxStat(eStat_HP);
...
defaultproperties
{
	UnitToSpawnName="Faceless_Leader"
