	...
	XComGameState NewGameState)
{
	...
	if (AbilityState.GetMyTemplateName() == 'SuppressionShot_LW' || AbilityState.GetMyTemplateName() == 'AreaSuppressionShot_LW' || AbilityState.GetMyTemplateName() == 'WalkFire')
	{
		if (AppliedData.AbilityResultContext.HitResult == eHit_Success)
		{
			...
			if (SourceWeapon != none)
			{
				...
				if (TargetUnit != none)
				{
					if (SourceUnit.HasSoldierAbility('SteadFast'))
					{
