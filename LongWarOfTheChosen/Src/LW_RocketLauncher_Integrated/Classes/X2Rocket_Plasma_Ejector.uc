class X2Rocket_Plasma_Ejector extends X2Item config(Rockets);

var config bool PLASMA_EJECTOR_ALWAYS_HITS;
...
static function X2DataTemplate Create_Rocket_Main()
{
	...
	local X2Effect_ApplyPlasmaEjectorDamage	WeaponDamageEffect;
	...
	Template.AddAbilityIconOverride('IRI_Fire_PlasmaEjector', "img:///IRI_RocketLaunchers.Fire_Plasma_Ejector");
	Template.AddAbilityIconOverride('IRI_Fire_PlasmaEjector_Spark', "img:///IRI_RocketLaunchers.Fire_Plasma_Ejector");
	Template.AddAbilityIconOverride('IRI_GiveRocket', "img:///IRI_RocketLaunchers.Give_Plasma_Ejector");
	Template.AddAbilityIconOverride('IRI_ArmRocket', "img:///IRI_RocketLaunchers.Arm_Plasma_Ejector");
	...
	WeaponDamageEffect = new class'X2Effect_ApplyPlasmaEjectorDamage';
	WeaponDamageEffect.bExplosiveDamage = true;
	WeaponDamageEffect.EffectDamageValue = default.BASEDAMAGE;
	WeaponDamageEffect.EnvironmentalDamageAmount = default.IENVIRONMENTDAMAGE;
	Template.ThrownGrenadeEffects.AddItem(WeaponDamageEffect);

	Template.OnThrowBarkSoundCue = 'PlasmaBlaster'; //'RocketLauncher';
	...
	Template.SetUIStatMarkup(class'XLocalizedData'.default.DamageLabel,, default.BASEDAMAGE.Damage);
	...
	Template.PairedTemplateName = 'IRI_X2Rocket_Plasma_Ejector_Pair';
...
static function X2DataTemplate Create_Rocket_Pair()
{
	...
	`CREATE_X2TEMPLATE(class'X2WeaponTemplate', Template, 'IRI_X2Rocket_Plasma_Ejector_Pair');
