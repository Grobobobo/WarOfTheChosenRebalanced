class X2Rocket_Sabot_T3 extends X2Item config(Rockets);
...
static function X2DataTemplate Create_Rocket_Main()
{
	...
	//Template.AddAbilityIconOverride('IRI_FireRocket', "img:///IRI_RocketLaunchers.Fire_Sabot");
	Template.AddAbilityIconOverride('IRI_GiveRocket', "img:///IRI_RocketLaunchers.Give_Sabot");
	Template.AddAbilityIconOverride('IRI_ArmRocket', "img:///IRI_RocketLaunchers.Arm_Sabot");
...
defaultproperties
{
	TemplateName = "IRI_X2Rocket_Sabot_T3"
}