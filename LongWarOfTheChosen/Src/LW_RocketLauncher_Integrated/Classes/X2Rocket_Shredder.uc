class X2Rocket_Shredder extends X2Item config(Rockets);

var localized string ShredderEffectLocName;
var localized string ShredderEffectLocDescription;

var name TemplateName;
var config bool CREATE_ROCKET;

var config WeaponDamageValue BaseDamage;
var config float DAMAGE_MULTIPLIER;
...
static function X2DataTemplate Create_Rocket_Main()
{
	...
	Template.AddAbilityIconOverride('IRI_FireRocket', "img:///IRI_RocketLaunchers.Fire_Shredder");
	Template.AddAbilityIconOverride('IRI_FireRocket_Spark', "img:///IRI_RocketLaunchers.Fire_Shredder");
	Template.AddAbilityIconOverride('IRI_GiveRocket', "img:///IRI_RocketLaunchers.Give_Shredder");
	Template.AddAbilityIconOverride('IRI_ArmRocket', "img:///IRI_RocketLaunchers.Arm_Shredder");
	...
	Template.SetUIStatMarkup(class'XLocalizedData'.default.RuptureLabel,, default.BASEDAMAGE.Rupture);
...
defaultproperties
{
	TemplateName = "IRI_X2Rocket_Shredder"
}