class X2Rocket_Standard extends X2Item config(Rockets);
...
static function X2DataTemplate Create_Rocket_Main()
{
	...
	`CREATE_X2TEMPLATE(class'X2RocketTemplate', Template, 'IRI_X2Rocket_Standard');

	Template.strImage = default.IMAGE;

	Template.AddAbilityIconOverride('IRI_FireRocket', "img:///IRI_RocketLaunchers.Fire_Standard");
	Template.AddAbilityIconOverride('IRI_FireRocket_Spark', "img:///IRI_RocketLaunchers.Fire_Standard");
	Template.AddAbilityIconOverride('IRI_GiveRocket', "img:///IRI_RocketLaunchers.Give_Standard");
	Template.AddAbilityIconOverride('IRI_ArmRocket', "img:///IRI_RocketLaunchers.Arm_Standard");
	...
	Template.PairedTemplateName = 'IRI_X2Rocket_Standard_Pair';
...
static function X2DataTemplate Create_Rocket_Pair()
{
	...
	`CREATE_X2TEMPLATE(class'X2WeaponTemplate', Template, 'IRI_X2Rocket_Standard_Pair');
