class X2Rocket_Thermobaric_T3 extends X2Item config(Rockets);
...
static function X2DataTemplate Create_Rocket_Main()
{
	...
	Template.AddAbilityIconOverride('IRI_FireRocket', "img:///IRI_RocketLaunchers.Fire_Thermobaric");
	Template.AddAbilityIconOverride('IRI_FireRocket_Spark', "img:///IRI_RocketLaunchers.Fire_Thermobaric");
	Template.AddAbilityIconOverride('IRI_GiveRocket', "img:///IRI_RocketLaunchers.Give_Thermobaric");
	Template.AddAbilityIconOverride('IRI_ArmRocket', "img:///IRI_RocketLaunchers.Arm_Thermobaric");
...
defaultproperties
{
	TemplateName = "IRI_X2Rocket_Thermobaric_T3"
}