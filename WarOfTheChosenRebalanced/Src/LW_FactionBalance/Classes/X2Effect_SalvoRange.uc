...
//---------------------------------------------------------------------------------------
class X2Effect_SalvoRange extends X2Effect_Persistent;
	...
	Object CallbackData)
{
	...
	{
		OverrideTuple.Data[1].i = class'X2LWModTemplate_SkirmisherAbilities'.default.SALVO_BONUS_RANGE;
	}
