...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Templates.AddItem(CreateDarkEventAbility('SteadyHands','Viper'));
	...
	Templates.AddItem(CreateDarkEventAbility('HyperReactivePupils','Trooper'));
	...
	Templates.AddItem(CreateDarkEventAbility('Sprinter','Chryssalid'));
	...
	Templates.AddItem(CreateDarkEventAbility('InstantReactionTime','SideWinder'));
	...
	Templates.AddItem(CreateDarkEventAbility('BerserkerBladestorm','Berserker'));
