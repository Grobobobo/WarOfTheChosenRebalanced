...
var config int ARTERIAL_STRIKE_PRIMARY_BLEED;
var config int ARTERIAL_STRIKE_BLEED_INCREASE;
...
static function X2DataTemplate FreeGrenades()
{
	...
	Template.IconImage = "img:///UILibrary_XPerkIconPack_LW.UIPerk_aliengrenade_cycle";
	Template.Hostility = eHostility_Neutral;
	Template.AbilitySourceName = 'eAbilitySource_Perk';
	Template.eAbilityIconBehaviorHUD = eAbilityIconBehavior_NeverShow;
...
static function X2AbilityTemplate ParalyzingBlows()
{
	...
	Template.IconImage = "img:///UILibrary_XPerkIconPack_LW.UIPerk_mind_crit";
	Template.eAbilityIconBehaviorHUD = EAbilityIconBehavior_NeverShow;
	Template.Hostility = eHostility_Neutral;
	...
	Template.AbilityTargetConditions.AddItem(default.MeleeCondition);
...
static function X2AbilityTemplate ParalyzingBlowsPassive()
{
	...
	Template = PurePassive('ParalyzingBlowsPassive', "img:///UILibrary_XPerkIconPack_LW.UIPerk_mind_crit", false);
	...
	static function X2AbilityTemplate HighVolumeFire()
{
	...
	Template.IconImage = "img:///UILibrary_FavidsPerkPack_LW.UIPerk_Imposition";
	Template.eAbilityIconBehaviorHUD = EAbilityIconBehavior_NeverShow;
	Template.Hostility = eHostility_Neutral;
...
static function X2AbilityTemplate HighVolumeFirePassive()
{
	...
	Template = PurePassive('HighVolumeFirePassive', "img:///UILibrary_FavidsPerkPack_LW.UIPerk_Imposition", false);
...
static function EventListenerReturn AbilityTriggerEventListener_HighVolumeFire(
	...
	Object CallbackData)
{
	return HandleApplyEffectEventTrigger('HighVolumeFire', EventData, EventSource, GameState);
}
...
static function X2AbilityTemplate ArterialStrike()
{
	local X2AbilityTemplate					Template;
	local X2AbilityTrigger_EventListener	EventListener;
	`CREATE_X2ABILITY_TEMPLATE(Template, 'ArterialStrike_LW');
	...
	EventListener = new class'X2AbilityTrigger_EventListener';
	EventListener.ListenerData.EventID = 'AbilityActivated';
	EventListener.ListenerData.EventFn = AbilityTriggerEventListener_ArterialStrike;
	EventListener.ListenerData.Deferral = ELD_OnStateSubmitted;
	EventListener.ListenerData.Priority = 40;
	EventListener.ListenerData.Filter = eFilter_Unit;
	...
	Template.AddTargetEffect(class'X2StatusEffects'.static.CreateBleedingStatusEffect(3, default.ARTERIAL_STRIKE_PRIMARY_BLEED));
	...
	Template.AdditionalAbilities.AddItem('ArterialStrikePassive_LW');
	
	return Template;
}

static function X2AbilityTemplate ArterialStrikePassive()
{
	local X2AbilityTemplate	Template;
	local X2Effect_ArterialStrike Effect;

	Template = PurePassive('ArterialStrikePassive_LW', "img:///UILibrary_XPACK_Common.PerkIcons.UIPerk_BloodTrail", false);

	Effect = new class'X2Effect_ArterialStrike';
	Effect.BuildPersistentEffect(1, true, true);
	Effect.BleedingDamageIncrease = default.ARTERIAL_STRIKE_BLEED_INCREASE;
	Template.AddTargetEffect(Effect);

	return Template;
}

static function EventListenerReturn AbilityTriggerEventListener_ArterialStrike(
	Object EventData,
	Object EventSource,
	XComGameState GameState,
	Name EventID,
