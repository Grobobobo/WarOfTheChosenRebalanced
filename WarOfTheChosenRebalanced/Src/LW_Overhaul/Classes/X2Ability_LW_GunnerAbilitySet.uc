...
static function X2AbilityTemplate CombativesStats()
{
	...
	StatEffect.Bonus_Crit_Damage = 0;
...
static function X2AbilityTemplate AddDisarmingStrike()
{
	...
	`CREATE_X2ABILITY_TEMPLATE(Template, 'DisarmingStrike_LW');

	Template.AbilitySourceName = 'eAbilitySource_Standard';
	Template.eAbilityIconBehaviorHUD = EAbilityIconBehavior_AlwaysShow;
	Template.IconImage = "img:///UILibrary_XPerkIconPack_LW.UIPerk_knife_cycle";
	Template.bHideOnClassUnlock = false;
	Template.ShotHUDPriority = class'UIUtilities_Tactical'.const.CLASS_SQUADDIE_PRIORITY;
	Template.AbilityConfirmSound = "TacticalUI_SwordConfirm";
	Template.bUniqueSource = true;
	...
	Cooldown = new class'X2AbilityCooldown';
    Cooldown.iNumTurns = default.DISARMING_STRIKE_COOLDOWN;
    Template.AbilityCooldown = Cooldown;
