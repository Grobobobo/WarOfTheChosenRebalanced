...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Templates.AddItem(PlasmaReload());
	Templates.AddItem(PlasmaReloadPassive());
...
static function X2AbilityTemplate PlasmaReload()
{
	local X2AbilityTemplate                 Template;	
	local X2Condition_UnitProperty          ShooterPropertyCondition;
	local X2Condition_AbilitySourceWeapon   WeaponCondition;
	...
	`CREATE_X2ABILITY_TEMPLATE(Template, 'PlasmaReload');
	...
	Template.AdditionalAbilities.AddItem('PlasmaReloadPassive');
...
static function X2AbilityTemplate PlasmaReloadPassive()
{
	local X2AbilityTemplate		Template;

	Template = PurePassive('PlasmaReloadPassive', "img:///UILibrary_PerkIcons.UIPerk_reload", , 'eAbilitySource_Perk');
