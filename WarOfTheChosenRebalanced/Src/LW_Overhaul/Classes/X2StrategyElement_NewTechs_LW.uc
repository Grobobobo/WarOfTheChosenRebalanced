...
//	Techs.AddItem(CreateTracerRoundsProjectTemplate());
	...
	//Breakthroughs get re-integrated as proving ground projects that increase damage
	Techs.AddItem(AddWeaponUpgradeBreakthrough1());
...
static function X2DataTemplate AddWeaponUpgradeBreakthrough1()
{
	local X2TechTemplate Template;

	`CREATE_X2TEMPLATE(class'X2TechTemplate', Template, 'BreakthroughWeaponUpgrade1');
...
static function BreakthroughWeaponUpgradeCompleted1(XComGameState NewGameState, XComGameState_Tech TechState)
{
	local XComGameState_HeadquartersXCom XComHQ;
...
static function X2DataTemplate AddWeaponUpgradeBreakthrough2()
{
	local X2TechTemplate Template;

	`CREATE_X2TEMPLATE(class'X2TechTemplate', Template, 'BreakthroughWeaponUpgrade2');
	Template.PointsToComplete = 2000;
	Template.strImage = "img:///UILibrary_XPACK_Common.BT_modAR";
...
function BreakthroughWeaponUpgradeCompleted2(XComGameState NewGameState, XComGameState_Tech TechState)
{
	local XComGameState_HeadquartersXCom XComHQ;
	local name Category;
	...
	foreach class'X2ItemTemplateManager'.default.WeaponCategories(Category)
	{
		XComHQ.ExtraUpgradeWeaponCats.AddItem(Category);
	}
}


static function X2DataTemplate CreateReinforcedUnderlay1()
{
	local X2TechTemplate Template;
	local X2BreakthroughCondition_ItemType TechCondition;

	`CREATE_X2TEMPLATE(class'X2TechTemplate', Template, 'ReinforcedUnderlay1');
	Template.PointsToComplete = 2000;
	Template.strImage = "img:///UILibrary_StrategyImages.ResearchTech.TECH_ExperimentalArmor";
	Template.SortingTier = 2;
	...
	Template.RewardName = 'ReinforcedUnderlay1';

	TechCondition = new class'X2BreakthroughCondition_ItemType';
	TechCondition.ItemTypeMatch = 'armor';
	Template.BreakthroughCondition = TechCondition;

	return Template;
}

static function X2DataTemplate CreateReinforcedUnderlay2()
{
	local X2TechTemplate Template;
	local X2BreakthroughCondition_ItemType TechCondition;

	`CREATE_X2TEMPLATE(class'X2TechTemplate', Template, 'ReinforcedUnderlay2');
	Template.PointsToComplete = 2000;
	Template.strImage = "img:///UILibrary_StrategyImages.ResearchTech.TECH_ExperimentalArmor";
	Template.SortingTier = 2;
	...
	Template.RewardName = 'ReinforcedUnderlay2';
...
static function X2DataTemplate LightningStrikeProject()
{
	local X2TechTemplate Template;

	`CREATE_X2TEMPLATE(class'X2TechTemplate', Template, 'LightningStrikeProject');
	Template.PointsToComplete = 2000;
	...
	Template.RewardName = 'LightningStrikeUnlock';
...
static function X2DataTemplate CreateLockOnProjectTemplate()
{
	local X2TechTemplate Template;

	`CREATE_X2TEMPLATE(class'X2TechTemplate', Template, 'LockOnProject');
	Template.SortingTier = 2;
	...
	Template.ResearchCompletedFn = GiveLockons;

	return Template;
}

static function X2DataTemplate CreateFlechetteProjectTemplate()
{
	local X2TechTemplate Template;

	`CREATE_X2TEMPLATE(class'X2TechTemplate', Template, 'FlechetteProject');
	Template.SortingTier = 2;
	Template.strImage = "img:///IRI_RocketLaunchers.PG_Experimental_Rocket";
	Template.bProvingGround = false;
	Template.bArmor = false;
	Template.PointsToComplete = StafferXDays(1, 15);

	Template.ResearchCompletedFn = GiveFlechettes;
	Template.ItemRewards.AddItem('ChameleonSuit');

	return Template;
}

static function X2DataTemplate CreatePlasmaEjectorProjectTemplate()
{
	local X2TechTemplate Template;

	`CREATE_X2TEMPLATE(class'X2TechTemplate', Template, 'PlasmaEjectorProject');
	Template.SortingTier = 2;
	Template.strImage = "img:///IRI_RocketLaunchers.PG_Experimental_Rocket";
	Template.bProvingGround = true;
	Template.bArmor = false;
	...
	Template.ResearchCompletedFn = GiveRandomItemReward;
	Template.ItemRewards.AddItem('IRI_X2Rocket_Plasma_Ejector');
...
static function GiveLockons(XComGameState NewGameState, XComGameState_Tech TechState)
{
	local XComGameStateHistory History;
	...
	ItemTemplate = ItemMgr.FindItemTemplate('IRI_X2Rocket_Lockon');
...
static function GiveFlechettes(XComGameState NewGameState, XComGameState_Tech TechState)
{
	local XComGameStateHistory History;
	local X2ItemTemplateManager ItemMgr;
	local XComGameState_Item ItemState;
	...
	ItemTemplate = ItemMgr.FindItemTemplate('IRI_X2Rocket_Flechette');
	if (ItemTemplate != none && !XComHQ.HasItem(ItemTemplate))
	{
		ItemState = ItemTemplate.CreateInstanceFromTemplate(NewGameState);
		XComHQ.AddItemToHQInventory(ItemState);
