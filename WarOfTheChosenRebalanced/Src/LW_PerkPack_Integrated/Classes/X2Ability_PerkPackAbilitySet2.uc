...
var config int STEADFAST_SHIELD_HP;

var config float BRAWLER2_DR_PER_TILE;
var config float BRAWLER2_MAX_DR;
var config float BRAWLER2_WOUND_REDUCTION;
...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Templates.AddItem(AddPhantomTrigger());
	...
	Templates.AddItem(ThreatAssessmentTrigger());
	Templates.AddItem(AddSilentTakedown_LW());	
	Templates.AddItem(CreateSilentAssassin());	
	Templates.AddItem(CreateSAPoison());	
	Templates.AddItem(AddPassiveMission());
	Templates.AddItem(AddDefensiveMission());
	Templates.AddItem(AddBalancedMission());
...
static function X2AbilityTemplate AddPhantomTrigger()
{
	local X2AbilityTemplate 			Template;
...
static function X2AbilityTemplate CreateBulletStorm()
{
	...
	Template = PurePassive('BulletStorm', "img:///UILibrary_XPerkIconPack_LW.UIPerk_suppression_bullet_x3", , 'eAbilitySource_Perk');
...
static function X2AbilityTemplate CreatePlatformStability()
{
	...
	Template = PurePassive('PlatformStability', "img:///UILibrary_XPerkIconPack_LW.UIPerk_rocket_shot", , 'eAbilitySource_Perk');
...
static function X2AbilityTemplate CreateImprovedProtocols()
{
	...
	Template = PurePassive('ImprovedProtocols', "img:///UILibrary_WOTC_APA_Class_Pack_LW.perk_HotChargedBatteries", , 'eAbilitySource_Perk');
...
static function X2AbilityTemplate CreateUnstoppableGunfire()
{
	...
	Template = PurePassive('UnstoppableGunfire', "img:///UILibrary_XPerkIconPack_LW.UIPerk_ammo_blaze", , 'eAbilitySource_Perk');
...
static function X2AbilityTemplate CreateSilentAssassin()
{
	...
	Template = PurePassive('SilentAssassin', "img:///StealthOverhaulUILibrary_LW.UIPerk_takedown", , 'eAbilitySource_Perk');

	Template.bDisplayInUITooltip = true;
	Template.bDisplayInUITacticalText = true;
	Template.DefaultSourceItemSlot = eInvSlot_SecondaryWeapon;
	Template.AdditionalAbilities.AddItem('SilentTakedown_LW');
	Template.AdditionalAbilities.AddItem('SAPoison');


	return Template;
}

static function X2AbilityTemplate ShotgunFireControl()
{
	local X2AbilityTemplate		Template;

	Template = PurePassive('ShotgunFireControl', "img:///UILibrary_LW_Overhaul.LW_AbilityFireControl", , 'eAbilitySource_Perk');
...
static function X2AbilityTemplate AddSilentTakedown_LW()
{
	...
	Template.ChosenActivationIncreasePerUse = class'X2AbilityTemplateManager'.default.StandardShotChosenActivationIncreasePerUse;
	Template.LostSpawnIncreasePerUse = class'X2AbilityTemplateManager'.default.MeleeLostSpawnIncreasePerUse;
	Template.OverrideAbilities.AddItem('Slash_LW');
	return Template;
}
...
static function X2AbilityTemplate CreateSAPoison()
{
	local X2AbilityTemplate					Template;
	local X2AbilityTrigger_EventListener	EventListener;
	`CREATE_X2ABILITY_TEMPLATE(Template, 'SAPoison');
	...
	EventListener.ListenerData.EventFn = AbilityTriggerEventListener_SAPoison;
	EventListener.ListenerData.Deferral = ELD_OnStateSubmitted;
...
static function EventListenerReturn AbilityTriggerEventListener_SAPoison(
	Object EventData,
	Object EventSource,
	...
	Object CallbackData)
{
	return HandleApplyEffectEventTrigger('SAPoison', EventData, EventSource, GameState);
}
...
static function X2AbilityTemplate CreateAdvancedRobotics()
{
	...
	Template = PurePassive('AdvancedRobotics_LW', "img:///UILibrary_WOTC_APA_Class_Pack_LW.perk_AdvancedRobotics", , 'eAbilitySource_Perk');
...
static function X2AbilityTemplate AddSawedOffReload()
{
	...
	Template.IconImage = "img:///UILibrary_LWSecondariesLWOTC.UIPerk_ReloadSawedOff";
...
static function X2DataTemplate ThreatAssessmentTrigger()
{
	local X2AbilityTemplate					Template;
	local X2AbilityTrigger_EventListener	EventListener;
	...
	`CREATE_X2ABILITY_TEMPLATE (Template, 'ThreatAssessmentTrigger');
	...
	EventListener = new class'X2AbilityTrigger_EventListener';
	EventListener.ListenerData.EventID = 'ThreatAssessmentActivated';
	EventListener.ListenerData.Deferral = ELD_OnStateSubmitted;
	EventListener.ListenerData.Filter = eFilter_None;
	EventListener.ListenerData.EventFn = ThreatAssessmentListener;
	Template.AbilityTriggers.AddItem(EventListener);
...
static function EventListenerReturn ThreatAssessmentListener(Object EventData, Object EventSource, XComGameState GameState, Name EventID, Object CallbackData)
{
	local XComGameStateContext_Ability AbilityContext;
	...
	{
		//	were we the killer?
		if (AbilityContext.InputContext.PrimaryTarget.ObjectID == TriggerAbilityState.OwnerStateObject.ObjectID)
		{
...
static function X2AbilityTemplate AddPassiveMission()
{
	local X2AbilityTemplate				Template;
	local X2Effect_Persistent			Effect;

	`CREATE_X2ABILITY_TEMPLATE(Template, 'PassiveMission_LW');
	...
	Effect.EffectName = 'PassiveMission';
...
static function X2AbilityTemplate AddDefensiveMission()
{
	local X2AbilityTemplate				Template;
	local X2Effect_Persistent			Effect;

	`CREATE_X2ABILITY_TEMPLATE(Template, 'DefensiveMission_LW');
	...
	Effect.BuildPersistentEffect(1, true, false, , eGameRule_PlayerTurnBegin);
	Effect.SetDisplayInfo(ePerkBuff_Passive, Template.LocFriendlyName, Template.GetMyHelpText(), Template.IconImage, false, , Template.AbilitySourceName);
	Effect.EffectName = 'DefensiveMission';
	Template.AddTargetEffect(Effect);
...
static function X2AbilityTemplate AddBalancedMission()
{
	local X2AbilityTemplate				Template;
	local X2Effect_Persistent			Effect;

	`CREATE_X2ABILITY_TEMPLATE(Template, 'BalancedMission_LW');
	...
	Effect.BuildPersistentEffect(1, true, false, , eGameRule_PlayerTurnBegin);
	Effect.SetDisplayInfo(ePerkBuff_Passive, Template.LocFriendlyName, Template.GetMyHelpText(), Template.IconImage, false, , Template.AbilitySourceName);
	Effect.EffectName = 'BalancedMission';
	Template.AddTargetEffect(Effect);
...
static function X2AbilityTemplate AddAggressiveMission()
{
	local X2AbilityTemplate				Template;
	local X2Effect_Persistent			Effect;

	`CREATE_X2ABILITY_TEMPLATE(Template, 'AggressiveMission_LW');
	...
	Effect.BuildPersistentEffect(1, true, false, , eGameRule_PlayerTurnBegin);
	Effect.SetDisplayInfo(ePerkBuff_Passive, Template.LocFriendlyName, Template.GetMyHelpText(), Template.IconImage, false, , Template.AbilitySourceName);
	Effect.EffectName = 'AggressiveMission';
	Template.AddTargetEffect(Effect);
...
static function X2AbilityTemplate AddBrawler2()
{
	local X2AbilityTemplate						Template;
	...
	DamageReduction = new class 'X2Effect_Brawler2';
	DamageReduction.DRPerTile = default.BRAWLER2_DR_PER_TILE;
	DamageReduction.MaxDR = default.BRAWLER2_MAX_DR;
...
static function X2AbilityTemplate AddShockAbsorbentArmor()
{
	...
	DamageReduction = new class 'X2Effect_Brawler2';
	DamageReduction.DRPerTile = default.SAA_DR_PER_TILE;
	DamageReduction.MaxDR = default.SAA_MAX_DR;
	DamageReduction.SetDisplayInfo(ePerkBuff_Passive, Template.LocFriendlyName, Template.GetMyLongDescription(), Template.IconImage, true,,Template.AbilitySourceName);
	DamageReduction.BuildPersistentEffect(1, true, false);
	Template.AddTargetEffect(DamageReduction);
