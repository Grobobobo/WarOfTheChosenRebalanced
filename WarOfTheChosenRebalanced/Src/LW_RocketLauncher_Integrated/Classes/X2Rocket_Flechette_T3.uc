class X2Rocket_Flechette_T3  extends X2Item config(Rockets);
...
var config float DAMAGE_MODIFIER_NO_COVER;
var config float DAMAGE_MODIFIER_TARGET_CANNOT_TAKE_COVER;
var config float DAMAGE_MODIFIER_MID_COVER;
var config float DAMAGE_MODIFIER_FULL_COVER;
...
static function X2DataTemplate Create_Rocket_Main()
{
	...
	//local X2Effect_ApplySpikesToWorld	WorldEffect;
	local int i;
	
	`CREATE_X2TEMPLATE(class'X2RocketTemplate', Template, default.TemplateName);

	Template.AddAbilityIconOverride('IRI_FireRocket', "img:///IRI_RocketLaunchers.Fire_Flechette");
	Template.AddAbilityIconOverride('IRI_FireRocket_Spark', "img:///IRI_RocketLaunchers.Fire_Flechette");
	Template.AddAbilityIconOverride('IRI_GiveRocket', "img:///IRI_RocketLaunchers.Give_Flechette");
	Template.AddAbilityIconOverride('IRI_ArmRocket', "img:///IRI_RocketLaunchers.Arm_Flechette");
	...
	//Template.fCoverage = class'X2Rocket_Flechette'.default.SPIKES_COVERAGE;
	...
	Template.Abilities.AddItem('IRI_FlechetteDamageModifier');
...
defaultproperties
{
	TemplateName = "IRI_X2Rocket_Flechette_T3"
}