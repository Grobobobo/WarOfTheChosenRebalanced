...
static function CHEventListenerTemplate CreateTacticalListeners()
{
	...
	Template.AddCHEvent('ChosenSighted', OnChosenSighted, ELD_OnStateSubmitted, 90);
	Template.AddCHEvent('AssassinSighted', OnAssassinSighted, ELD_OnStateSubmitted, 80);
	Template.AddCHEvent('WarlockSighted', OnWarlockSighted, ELD_OnStateSubmitted, 80);
	Template.AddCHEvent('HunterSighted', OnHunterSighted, ELD_OnStateSubmitted, 80);
