...
var config WeaponDamageValue ADV_PURIFIER_PISTOL_LEADER_WPN_BASEDAMAGE;
var config WeaponDamageValue ADV_PURIFIER_PISTOL_M2_LEADER_WPN_BASEDAMAGE;
var config WeaponDamageValue ADV_PURIFIER_PISTOL_M3_LEADER_WPN_BASEDAMAGE;
var config WeaponDamageValue ADV_PURIFIER_PISTOL_M4_LEADER_WPN_BASEDAMAGE;
var config WeaponDamageValue ADV_PURIFIER_PISTOL_M5_LEADER_WPN_BASEDAMAGE;
...
var config WeaponDamageValue ADVPURIFIER_LEADER_FLAMETHROWER_BASEDAMAGE;
var config WeaponDamageValue ADVPURIFIERM2_LEADER_FLAMETHROWER_BASEDAMAGE;
var config WeaponDamageValue ADVPURIFIERM3_LEADER_FLAMETHROWER_BASEDAMAGE;
var config WeaponDamageValue ADVPURIFIERM4_LEADER_FLAMETHROWER_BASEDAMAGE;
var config WeaponDamageValue ADVPURIFIERM5_LEADER_FLAMETHROWER_BASEDAMAGE;
...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Weapons.AddItem(CreateTemplate_AdvPurifierPistol_Leader_WPN('AdvPurifierPistol_Leader_WPN', default.ADV_PURIFIER_PISTOL_LEADER_WPN_BASEDAMAGE));
	Weapons.AddItem(CreateTemplate_AdvPurifierPistol_Leader_WPN('AdvPurifierPistolM2_Leader_WPN', default.ADV_PURIFIER_PISTOL_M2_LEADER_WPN_BASEDAMAGE));
	Weapons.AddItem(CreateTemplate_AdvPurifierPistol_Leader_WPN('AdvPurifierPistolM3_Leader_WPN', default.ADV_PURIFIER_PISTOL_M3_LEADER_WPN_BASEDAMAGE));
    ...
    Weapons.AddItem(CreateTemplate_AdvPurifierFlamethrower_Leader('AdvPurifier_LeaderFlamethrower',default.ADVPURIFIER_LEADER_FLAMETHROWER_BASEDAMAGE));
    Weapons.AddItem(CreateTemplate_AdvPurifierFlamethrower_Leader('AdvPurifierM2_LeaderFlamethrower',default.ADVPURIFIERM2_LEADER_FLAMETHROWER_BASEDAMAGE));
    Weapons.AddItem(CreateTemplate_AdvPurifierFlamethrower_Leader('AdvPurifierM3_LeaderFlamethrower',default.ADVPURIFIERM3_LEADER_FLAMETHROWER_BASEDAMAGE));
    Weapons.AddItem(CreateTemplate_AdvPurifierFlamethrower_Leader('AdvPurifierM4_LeaderFlamethrower',default.ADVPURIFIERM4_LEADER_FLAMETHROWER_BASEDAMAGE));
    Weapons.AddItem(CreateTemplate_AdvPurifierFlamethrower_Leader('AdvPurifierM5_LeaderFlamethrower',default.ADVPURIFIERM5_LEADER_FLAMETHROWER_BASEDAMAGE));
...
static function X2DataTemplate CreateTemplate_AdvPurifierPistol_Leader_WPN(name TemplateName, WeaponDamageValue Damage)
{
	local X2WeaponTemplate Template;
...
static function X2WeaponTemplate CreateTemplate_AdvPurifierFlamethrower_Leader(name TemplateName, WeaponDamageValue Damage)
{
	local X2WeaponTemplate Template;
